...
function [u_opt, x_opt, stats] = adip_solver(optim, x0, x, u) %#codegen
%ADIP_SOLVER Stub that specializes the qLMPC solver for the ADIP model
...
[u_opt, x_opt, stats] = qlmpc_solver(optim, @adip_lpv, 4, 1, x0, x, u);
end
